...
| `pivot`            | `packages/pivot`            | `@oge-ui/pivot`            | Pivot grid on top of `core`'s PivotEngine. Commercial.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `bpmn`             | `packages/bpmn`             | `@oge-ui/bpmn`             | Commercial BPMN 2.0 modeler: framework-free `engine/` (model, geometry, XML + DI reader/writer, routing, command stack) + `oge-bpmn-editor` (`role="application"` canvas). Self-contained by design — depends on nothing (not even `core`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `gantt`            | `packages/gantt`            | `@oge-ui/gantt`            | Commercial Gantt chart: framework-free `engine/` (tree/schedule/critical-path/time-scale/gesture math) + `oge-gantt` (virtualized treegrid pane + timeline chart, drag editing, undo/redo, task dialog). Like the scheduler, a deliberate consumer of the MIT suite (`core`, `overlay`, `inputs`, `forms`). Lazy secondary entries: `/export-excel`, `/export-pdf`, `/export-image`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `kanban`           | `packages/kanban`           | `@oge-ui/kanban`           | Commercial Kanban board: framework-free `engine/` (board model + write-back, drag hit-testing, per-column virtual windows, WIP arithmetic) + `oge-kanban` (columns/swimlanes, WIP limits with drag previews, drag & drop with Escape-cancel and edge auto-scroll, Ctrl+Arrow keyboard card moving with live announcements, built-in `OgeForm` dialog + context menu + toolbar). Composes the listbox pattern (no APG kanban pattern exists). A consumer of the MIT suite: `core`, `overlay`, `forms` (transitively `inputs`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `charts`           | `packages/charts`           | `@oge-ui/charts`           | Commercial charts: dependency-free SVG rendering over a pure kernel; cartesian series + pie/doughnut, zoom & pan, crosshair, tooltips, legend. Depends only on `core` and `overlay`. Lazy secondary entry: `/export-image`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `react-overlay`    | `packages/react/overlay`    | `@oge-ui/react-overlay`    | **React.** The whole overlay family on `@oge-ui/behavior`: `useAnchoredPanel` + `<OgePopup>`, `<OgeMenuList>` (nested submenus, type-ahead), `<OgeTooltip>`, `<OgeContextMenu>`, `<OgeModal>` + `OgeModalProvider` (async close guards, drag/resize, focus trap), `<OgeToastRegion>` + `useOgeToast` (stacking, pause-on-hover, coalescing, promise morphing), `<OgeOverlayConfigProvider>`. Same machines, same stylesheet as the Angular overlay.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `react-inputs`     | `packages/react/inputs`     | `@oge-ui/react-inputs`     | **React.** The full editor set (15 components) on one field chrome, driven by `@oge-ui/behavior`'s input commit, select-list, virtualizer, calendar/date/number/slider/color machines. `<OgeInputsConfigProvider>`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `react-layout`     | `packages/react/layout`     | `@oge-ui/react-layout`     | **React.** Card, accordion, splitter, toolbar (`before`/`center`/`after` slots + overflow), progress bar, load indicator, skeleton — on the layout cores in `behavior`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- **Docs previews inline that stylesheet.** The React demo components carry
  ...
  for a whole package stylesheet, not an app component's.
...
`packages/charts`**, which are source-available commercial (free for
