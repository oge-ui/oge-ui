...
| `react-overlay` | `packages/react/overlay` | `@oge-ui/react-overlay` | **React.** Overlay primitives on `@oge-ui/behavior`'s `OgeAnchoredPanelCore` and menu machines — the same code the Angular overlay wraps with signals. `useAnchoredPanel` (hook seam), `<OgePopup>` chrome, `<OgeMenuList>` (WAI-ARIA menu incl. nested submenus + type-ahead), `<OgeOverlayConfigProvider>`. Tooltip/modal/toast follow as the layer scales.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
