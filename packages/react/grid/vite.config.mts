...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../node_modules/.vite/packages/react/grid',
  plugins: [
    react(),
    nxViteTsPaths(),
    publishAssets('../../../dist/packages/react/grid'),
    dts({
      entryRoot: 'src',
  ...
  build: {
    outDir: '../../../dist/packages/react/grid',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../../coverage/packages/react/grid',
