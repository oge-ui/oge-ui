...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../node_modules/.vite/packages/react/inputs',
  plugins: [
    react(),
    nxViteTsPaths(),
    publishAssets('../../../dist/packages/react/inputs'),
    dts({
      entryRoot: 'src',
  ...
  build: {
    outDir: '../../../dist/packages/react/inputs',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../../coverage/packages/react/inputs',
