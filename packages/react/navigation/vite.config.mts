...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../node_modules/.vite/packages/react/navigation',
  plugins: [
    react(),
    nxViteTsPaths(),
    publishAssets('../../../dist/packages/react/navigation'),
    dts({
      entryRoot: 'src',
  ...
  build: {
    outDir: '../../../dist/packages/react/navigation',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../../coverage/packages/react/navigation',
