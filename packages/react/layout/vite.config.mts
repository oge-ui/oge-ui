...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../node_modules/.vite/packages/react/layout',
  plugins: [
    react(),
    nxViteTsPaths(),
    publishAssets('../../../dist/packages/react/layout'),
    dts({
      entryRoot: 'src',
  ...
  build: {
    outDir: '../../../dist/packages/react/layout',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../../coverage/packages/react/layout',
