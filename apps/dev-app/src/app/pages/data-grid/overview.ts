  ...
  template: `
    ...
    @if (fw.isReact()) {
      ...
      <ul>
        ...
        <li>
          Numbers and dates are written as <em>typed</em> Excel cells; lookup
          and boolean columns use their display text.
        </li>
        <li>
      ...
      <p>
        ...
        <code>ogeToolbar</code> attribute — any projected element with it lands
        in the grid's toolbar next to the built-in controls.
      </p>
