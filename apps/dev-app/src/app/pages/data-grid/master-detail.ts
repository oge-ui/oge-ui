...
import { ReactGridMasterDetailDemos } from '../react-grid/master-detail';
...
@Component({
  ...
  template: `
    <app-doc-header
      ...
      [chips]="
        fw.isReact()
          ? ['renderDetail', 'detailRowHeight', 'treegrid']
    ...
    @if (fw.isReact()) {
      <app-react-grid-master-detail-demos />
    } @else {
