...
/**
 * Hand-compiled from packages/navigation/src/lib/tree-view/** — keep in sync
 * with the source TSDoc when the public API changes.
 */
export const OGE_TREE_VIEW_API: ApiSections = {
  properties: [
    {
      ...
      entries: [
        {
          ...
          default: '[]',
          description: 'Keys of the expanded nodes.',
        },
        {
          name: 'selectedKeys',
          type: 'readonly RowKey[]',
      ...
      entries: [
        {
          ...
          description:
            'Expands a node, awaiting the lazy child fetch when there is one. Resolves <code>false</code> if the node is unknown or <code>itemExpanding</code> vetoed it.',
        },
        {
          name: 'collapse(key)',
          type: '(key: RowKey) => Promise&lt;boolean&gt;',
  ...
  events: [
    {
      entries: [
        {
          name: 'itemExpanding / itemCollapsing',
          type: 'OgeTreeExpandingEvent&lt;T&gt; / OgeTreeCollapsingEvent&lt;T&gt;',
          description:
            'Cancelable pre-events — set <code>cancel = true</code> to block the change.',
        },
        {
          name: 'itemExpanded / itemCollapsed',
          type: 'OgeTreeExpandedEvent&lt;T&gt; / OgeTreeCollapsedEvent&lt;T&gt;',
          description: 'Emitted after the change committed.',
        },
        {
          name: 'selectionChanging',
          type: 'OgeTreeSelectionChangingEvent&lt;T&gt;',
          description:
            'Cancelable pre-event carrying the keys the selection would become.',
        },
        {
          name: 'selectionChanged',
          type: 'OgeTreeSelectionChangedEvent&lt;T&gt;',
          description:
            'Emitted after the selection committed, with <code>previousKeys</code>.',
        },
        {
          name: 'itemSelectionChanged',
          type: 'OgeTreeItemSelectionChangedEvent&lt;T&gt;',
          description: 'Emitted for the single node whose own state flipped.',
        },
        {
          name: 'itemClick / itemDblClick',
          type: 'OgeTreeItemClickEvent&lt;T&gt;',
          description: 'Emitted when a node row is clicked or double-clicked.',
        },
        {
          name: 'childrenLoaded / childrenLoadFailed',
          type: 'OgeTreeChildrenLoadedEvent&lt;T&gt; / OgeTreeChildrenFailedEvent&lt;T&gt;',
          description:
            'Emitted after a lazy <code>loadChildren</code> settled; the failure carries the original error.',
        },
        {
          name: 'selectAllChanged',
          type: 'OgeTreeSelectAllChangedEvent',
          description: 'Emitted when the "select all" row is toggled.',
        },
        {
          name: 'itemReordering / itemReordered',
          type: 'OgeTreeReorderingEvent&lt;T&gt; / OgeTreeReorderedEvent&lt;T&gt;',
          description:
  ...
  types: [
    {
      ...
      entries: [
        {
          name: '[ogeTreeItemTemplate]',
          type: '{ $implicit, key, level, expanded, selected, checkState, hasChildren, highlightedHtml }',
          description:
            'Replaces a node\'s built-in label. Renders inside <code>role="treeitem"</code>, so it must not contain focusable controls.',
        },
        {
          name: '[ogeTreeExpandIconTemplate]',
          type: '{ $implicit: boolean, item, key, loading }',
          description: 'Replaces the expand/collapse chevron.',
        },
        {
          name: '[ogeTreeNoDataTemplate]',
          type: '—',
          description:
...
export const OGE_TREE_VIEW_CONFIG_API: ApiSections = {
  properties: [
    {
  ...
  types: [
    {
      ...
      entries: [
        ...
        },
        {
          ...
          description: 'Default for the <code>expandEvent</code> input.',
        },
      ],
    },
    {
      entries: [
        {
          name: 'provideOgeTreeViewConfig(config)',
          type: '(config: OgeTreeViewConfigInput) => Provider',
          description:
            'Application- or component-scoped defaults; shallow-merges <code>messages</code> over the built-ins.',
        },
        {
          name: 'OGE_TREE_VIEW_CONFIG',
          type: 'InjectionToken&lt;OgeTreeViewConfig&gt;',
          description:
