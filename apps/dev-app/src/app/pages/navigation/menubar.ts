...
@Component({
  ...
  imports: [DemoCard, DocHeader, PageToc, OgeMenubar, OgeMenubarItem],
  ...
  template: `
    ...
    >
      <p>
        ...
        between items, Down/Enter into a submenu, Escape unwinding one level at
        a time, type-ahead. Submenus — nested ones included — run on the same
        <code>oge-menu-list</code> and Escape stack as every other menu in the
        suite.
      </p>
      <p>
