  ...
  template: `
    ...
    >
      <p>
        ...
        spinners and shimmers every OGE surface carried before. All announce as
        <code>role="progressbar"</code> with the ARIA rule most libraries miss:
    ...
    >
      <div aria-busy="true" class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <oge-skeleton class="mt-2 block" [width]="'40%'" animation="pulse" />
        </div>
      </div>
