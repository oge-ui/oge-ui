...
const SINGLE_SNIPPET = `<oge-button-group
...
const MULTI_SNIPPET = `<oge-button-group
...
const ITEMS_SNIPPET = `<oge-button-group
  selectionMode="single"
  [items]="periods"
  [(selectedKeys)]="period"
  size="sm"
...
@Component({
  ...
  imports: [OgeButton, OgeButtonGroup, DemoCard, DocHeader, PageToc],
  ...
  template: `
    ...
    >
      <p>
        <code>&lt;oge-button-group&gt;</code> lays out buttons as one segmented
