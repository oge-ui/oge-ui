...
@Component({
  ...
  imports: [DemoCard, DocHeader, PageToc, OgeColorBox, OgeForm],
  ...
  template: `
    ...
    >
      <p>
        A color editor on the shared field chrome: the field shows a live swatch
        and the committed CSS color string; the popup composes a
      ...
      <p>
        ...
        the string format contract, typed CSS color input, swatch governance or
        the draft/OK commit flow.
      </p>
    </app-doc-header>
